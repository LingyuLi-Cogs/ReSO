...
class SimpleDataSaver:
    ...
    async def save_session_summary(self, session_data: Dict, session_folder: str, context=None) -> str:
        ...
        query_success_rate = (
            len(successful_queries) / len(query_results) * 100
...
Success Rate: {query_success_rate:.1f}%
...
"""
        ...
        overall_attack_success_rate = (
            total_successful_attacks / total_attacks * 100
            if total_attacks else 0.0
        )
...
Overall Attack Success Rate: {overall_attack_success_rate:.1f}%
