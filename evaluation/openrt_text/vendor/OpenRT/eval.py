...
def parse_args():
    ...
    parser.add_argument("--image-library-path", type=str,
                       default=os.getenv("OPENRT_IMAGE_LIBRARY_PATH"),
                       help="Optional local image library used by the CSDJ attack")
...
def get_available_attacks(attacker_model, judge, args, image_generator):
    ...
    ("CSDJ", CSDJAttack, {
        "attacker_model": attacker_model,
        "image_library_path": args.image_library_path,
        "judge": judge,
        "verbose": False
    }),
    ("DrAttack", DrAttack, {
